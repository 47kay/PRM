...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/*! import() */ "vendors-node_modules_aws-sdk_nested-clients_dist-es_submodules_sso-oidc_index_js").then(__webpack_require__.bind(__webpack_require__, /*! @aws-sdk/nested-clients/sso-oidc */ "../node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/index.js"));
...
const getSsoOidcClient = async (ssoRegion, init = {}) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/*! import() */ "vendors-node_modules_aws-sdk_nested-clients_dist-es_submodules_sso-oidc_index_js").then(__webpack_require__.bind(__webpack_require__, /*! @aws-sdk/nested-clients/sso-oidc */ "../node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/index.js"));
